"""
Django settings for wfafsadf_3 project.
...
WSGI_APPLICATION = 'wfafsadf_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wfafsadf_3 API",
    "DESCRIPTION": "API documentation for wfafsadf_3 App",
    "VERSION": "v1",
}
